...
const storeProduct = async () => {
  await useApi("/admin/products/store", {
    method: "POST",
    body: {
      ...storeData.value,
...
<template>
  ...
  <form action="" class="mt-12 pb-20" @submit.prevent="storeProduct">
    <FormInput
      required="true"
      label="Название"
      ...
      <div class="grid gap-[100px] grid-cols-[1fr_400px]">
        ...
        <div>
          <div class="flex flex-col">
            ...
            <div
              class="w-[400px] h-[400px] mt-2 relative rounded-lg overflow-hidden"
            >
              <img
                :src="coverRef"
                alt=""
